...
class srcDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = [
            ...
            'app\\form\\createuser' => 'App\\Form\\CreateUser',
            'app\\form\\imageupload' => 'App\\Form\\ImageUpload',
            'app\\form\\login' => 'App\\Form\\Login',
            'app\\repository\\imagerepository' => 'App\\Repository\\ImageRepository',
        ...
        $this->fileMap = [
            ...
            'App\\Form\\CreateUser' => 'getCreateUserService.php',
            'App\\Form\\ImageUpload' => 'getImageUploadService.php',
            'App\\Form\\Login' => 'getLoginService.php',
            'App\\Repository\\ImageRepository' => 'getImageRepositoryService.php',
        ...
        $this->privates = [
            ...
            'App\\Form\\CreateUser' => true,
            'App\\Form\\ImageUpload' => true,
            'App\\Form\\Login' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('H-Ewq-xFr9', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('r9ouiRyOfU', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SEqstmjbl3', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('L91fOqduLD', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
