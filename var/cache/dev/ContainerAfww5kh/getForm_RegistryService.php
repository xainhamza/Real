...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['App\\Form\\CreateUser' => function () {
    return ${($_ = isset($this->services['App\\Form\\CreateUser']) ? $this->services['App\\Form\\CreateUser'] : ($this->services['App\\Form\\CreateUser'] = new \App\Form\CreateUser())) && false ?: '_'};
}, 'App\\Form\\ImageUpload' => function () {
    return ${($_ = isset($this->services['App\\Form\\ImageUpload']) ? $this->services['App\\Form\\ImageUpload'] : ($this->services['App\\Form\\ImageUpload'] = new \App\Form\ImageUpload())) && false ?: '_'};
}, 'App\\Form\\Login' => function () {
    return ${($_ = isset($this->services['App\\Form\\Login']) ? $this->services['App\\Form\\Login'] : ($this->services['App\\Form\\Login'] = new \App\Form\Login())) && false ?: '_'};
